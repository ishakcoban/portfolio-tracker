    ...
    <div className="d-flex align-items-center justify-content-center">
      <div className="text-white">
        <div>
          ...
          {/* Gauge Container */}
          <div className="position-relative mx-auto mb-4" style={{ maxWidth: '350px', aspectRatio: '2/1.2' }}>
            <svg className="w-100 h-100" viewBox="0 0 200 120" key={indexData.type}>
              <defs>
                {/* Crypto gradient */}
              ...
              <path
                d="M 20 100 A 80 80 0 0 1 180 100"
                fill="none"
                stroke={isCrypto ? "url(#cryptoGradient)" : "url(#vixGradient)"}
                strokeWidth="20"
                strokeLinecap="round"
              />
            ...
            >
              ...
              <div className="mt-2" style={{ color: indexData.color,fontSize:".9rem" }}>
